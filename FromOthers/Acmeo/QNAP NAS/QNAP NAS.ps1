...
elseif($null -eq $nasHDDStatus2 -or $nasHDDStatus2 -eq "")
{
...
elseif($null -eq $nasHDDStatus3 -or $nasHDDStatus3 -eq "")
{
...
elseif($null -eq $nasHDDStatus4 -or $nasHDDStatus4 -eq "")
{
...
elseif($null -eq $nasHDDStatus5 -or $nasHDDStatus5 -eq "")
{
...
elseif($null -eq $nasHDDStatus6 -or $nasHDDStatus6 -eq "")
{
...
elseif($null -eq $nasHDDStatus7 -or $nasHDDStatus7 -eq "")
{
...
elseif($null -eq $nasHDDStatus8 -or $nasHDDStatus8 -eq "")
{
