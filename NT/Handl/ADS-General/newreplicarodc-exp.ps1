<#
	...
	.EXAMPLE
		. .\newreplicarodc.ps1
		New-ADReplicaRODC -Computername vdc02 -ParentDiskPath D:\pd\2008R2\2008R2.vhdx -VMPath V:\VMs\Test -IPv4Address 192.168.0.2 -SubnetMask '255.255.255.0' -DomainName test.de -LegacyDC -DNSServer 192.168.0.1 -SiteName RODCs
	...
	begin
	{
		...
		switch ($LegacyDC)
		{
			true {
				...
				Add-Content -Path "$VMPath\$Computername\Virtual Hard Disks\DCPromo.cmd" -Value "dcpromo.exe /answer:DCPromo-Replica-$NetBIOSName.txt"
