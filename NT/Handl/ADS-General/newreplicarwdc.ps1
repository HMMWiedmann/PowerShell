<#
	...
	.EXAMPLE
		. .\newreplicarwdc.ps1
		New-ADReplicaDC -Computername vdc02 -ParentDiskPath D:\pd\2008R2\2008R2.vhdx -VMPath V:\VMs\Test -IPv4Address 192.168.0.2 -SubnetMaskLength 24 -DomainName test.de -LegacyDC -DNSServer 192.168.0.1
	...
	.NOTES
		...
		Version 1.0.8 - 01/29/2018 - Martin Handl - Subnet mask bits implemented
