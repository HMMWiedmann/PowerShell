<#
	...
	.EXAMPLE
		...
		New-ADMemberWorkstation -Computername TestWK -ParentDiskPath c:\PD\Win7\Win7.vhdx -VMPath v:\VMs -IPv4Address 192.168.1.1 -SubnetMaskLength 24 -DNSServer 192.168.1.2 -DomainName Test.de -LegacyWorkstation
