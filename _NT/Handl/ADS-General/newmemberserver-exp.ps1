<#
	...
	.EXAMPLE
		. .\newmemberserver.ps1
		New-ADMemberServer -Computername TestSV -ParentDiskPath c:\PD\2008R2\2008R2.vhdx -VMPath v:\VMs -IPv4Address 192.168.1.1 -SubnetMask 255.255.255.0 -DNSServer 192.168.1.2 -DomainName Test.de -LegacyServer
